...
/**
 * Conversor JSF entidad MarReportesConverter.
 *
 * @author Fabián Agudelo
 * @version 1.0
 * @since JDK1.7
 */
@FacesConverter(value = "MarReportesConverter")
public class MarReportesConverter implements Converter {

    final static Logger logger = Logger.getLogger(MarReportesConverter.class);

    private GenericDAOBeanLocal genericDAOBeanLocal;

    public MarReportesConverter() {
        try {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        MarReportes tipo = null;
        try {
            tipo = (MarReportes) genericDAOBeanLocal.findByID(MarReportes.class, new BigDecimal(value));
        } catch (Exception ex) {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        return String.valueOf(((MarReportes) value).getRepId());
    }
