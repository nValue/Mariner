...
public class FinalizacionManagedBean extends GenericManagedBean{
    ...
    public void buscarRadicaciones(){
        try {
            ...
            radicaciones = radicacionesDAOBean.obtenerRadicacionesFinalizacionPorFechasYParametro(filtroBusquedaSel.getClave(), campoBusqueda, fechaFiltroInic, fechaFiltroFin);    
